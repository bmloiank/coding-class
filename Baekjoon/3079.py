# 과제) 입국심사 https://www.acmicpc.net/problem/3079
...
20초가 되었을 때, 여섯번째 사랄이 갈수 있는데 두 번째 심사대가 비어있게 된다.  -> 30초 끝남
21초가 되었을때 여섯 번째 사람이 그 곳으로 이동하지 않고, 1초를 더 기다린 다음에 첫 번째 심사대로 이동해서 심사를 받으면, -> 28초에 끝남
